...
public class WaitConcept 
{
	...
	public void waitTest()
	{
		...
		SelenideElement email = $(By.xpath("//input[@type='text']"));
		
      email.should(Condition.visible, Duration.ofSeconds(10)).sendKeys("babu");	
		
		actions().moveToElement($(By.linkText("Sign Up"))).click().build().perform();
		
		SelenideElement checkBox = $(By.xpath("//input[@type='checkbox']"));
		//checkBox.click();
