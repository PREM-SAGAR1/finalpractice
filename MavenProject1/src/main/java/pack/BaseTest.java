...
public class BaseTest 
{
	...
	public static String pojectMainSource = "\\src\\main\\resources";
	...
	{
		fis = new FileInputStream(projectPath+pojectMainSource+"\\data.properties");
		p = new Properties();
		p.load(fis);
		
		fis = new FileInputStream(projectPath+pojectMainSource+"\\environment.properties");
		mainprop = new Properties();
		mainprop.load(fis);
		String e = mainprop.getProperty("env");
		System.out.println(e);
		
		fis = new FileInputStream(projectPath+pojectMainSource+ "\\"+e+".properties");
		childProp = new Properties();
		childProp.load(fis);
		System.out.println(childProp.getProperty("amazonurl"));
		
		fis = new FileInputStream(projectPath+pojectMainSource+"\\or.properties");
		orProp = new Properties();
		orProp.load(fis);
		
		fis = new FileInputStream(projectPath+pojectMainSource+"\\log4jconfig.properties");
